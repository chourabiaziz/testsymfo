...
final class PlayerController extends AbstractController
{
    ...
    public function index(PlayerRepository $playerRepository ,ManagerRegistry $doctrine , EntityManagerInterface $em): Response
    {
      //  $players = $playerRepository->findbyshirtnumber();

        //dql
        $requete = "select p from App\Entity\Player p where p.shirt_number > 500 order by p.created_at ASC";
